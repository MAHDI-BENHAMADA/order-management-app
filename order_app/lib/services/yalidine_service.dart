...
class YalidineService {
  static const String baseUrl = 'https://www.yalidine.app/api';
  ...
  static Future<String?> createShipment(AppOrder order) async {
    if (_apiToken == null) {
      throw Exception('Yalidine API Token not set');
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Yalidine API Error: ${response.statusCode}');
      }
    } catch (e) {
      throw Exception('Yalidine Shipment Error: $e');
    }
  }
}
